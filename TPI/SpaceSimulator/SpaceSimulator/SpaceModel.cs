...
# Nom du fichier : Space Simulator : SpaceModel.cs
# Date : 19 juin 2017
#--------------------------------------------------------------------------
# Modèle de l'application
# Sert de base pour toutes les interactions de données du programme
#
...
namespace SpaceSimulator
{
    public class SpaceModel
    {
        ...
        /// <summary>
        /// Initialise l'âge de l'espace, le niveau de zoom, le vitesse du temps, L'etat du dessin et crée les objets célestes en fonction de la base de données.
        /// </summary>
        public SpaceModel()
        {
            SpaceDayAge = 0;
        ...
        /// <summary>
        /// Supprime la planète de la liste des planètes et de la base de données.
        /// </summary>
        /// <param name="destroyedPlanet"></param>
        ...
        /// <summary>
        /// Insère une lune avec les données saisies dans la base de données puis lis l'objet en base et crée la lune dans le programme.
        /// </summary>
        /// <param name="name">nom</param>
        /// <param name="ray">rayon en kilomètres</param>
        /// <param name="period">durée d'une révolution en cours</param>
